...
Placing these vectors into a [Vector index](https://neo4j.com/docs/cypher-manual/current/indexes/semantic-indexes/vector-indexes/) allows you to perform semantic searches, similarity searches, and clustering on the data.
